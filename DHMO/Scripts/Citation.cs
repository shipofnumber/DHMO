...
public static class DHMOCitations
{
    ...
    public static Citation DHMO { get; private set; } = new("DHMO", NebulaAPI.AddonAsset.GetResource("Citation/DHMO.png")?.AsImage(80f), new ColorTextComponent(VColor.White, new RawTextComponent("DHMO")), "https://github.com/shipofnumber/DHMO");
}